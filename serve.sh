...
docker-compose run -d --name tailwind-watcher hugo sh -c "cd /src && npx tailwindcss -i ./assets/css/style.css -o ./static/css/output.css --config ./tailwind.config.js --watch"
